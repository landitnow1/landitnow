...
var plSTF="width",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="550px",plHeight="900px";

preContent={
    dom: [
    {
        id: 'Landit_Logo_Black2',
        type: 'image',
        tag: 'img',
        rect: ['139px', '289px','263px','281px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/Landit%20Logo%20Black.png','0px','0px']
    },
    {
        id: 'loader-bar',
        type: 'image',
        tag: 'img',
        rect: ['160px', '562px','220px','19px','auto', 'auto'],
